                        ...
                        <div className="row gy-2">
                            ...
                            <div className="col-md-6 col-12">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="presionArterial" id="presionArterial" className="form-control" disabled value={atencion.presionArterial} />
                                </div>
                            </div>
                            <div className="col-md-6 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Temperatura C°</label>
                                    <input type="text" name="temperatura" id="temperatura" className="form-control" disabled value={atencion.temperatura} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Frecuencia respiratoria (Por minuto)</label>
                                    <input type="text" name="frecuenciaRespiratoria" id="frecuenciaRespiratoria" className="form-control" disabled value={atencion.frecuenciaRespiratoria} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Frecuencia cardiaca (Por minuto)</label>
                                    <input type="text" name="frecuenciaCardiaca" id="frecuenciaCardiaca" className="form-control" disabled value={atencion.frecuenciaCardiaca} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label className="form-label">Saturación (O<sub>2</sub>)</label>
                                    <input type="text" name="saturacion" id="saturacion" className="form-control" disabled value={atencion.saturacion} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Peso</label>
                                    <input type="text" name="peso" id="peso" className="form-control" disabled value={atencion.peso} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Talla</label>
                                    <input type="text" name="talla" id="talla" className="form-control" disabled value={atencion.talla} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">IMC</label>
                                    <input type="text" name="imc" id="imc" className="form-control" disabled value={atencion.imc} />
                                </div>
                            </div>
                        ...
                        <div className="row gy-2">
                            ...
                            <div className="col-md-9 col-12">
                                <div className="form-group">
                                    ...
                                    <textarea name="motivoConsulta" id="motivoConsulta" cols="30" rows="7" className="form-control" disabled value={atencion.motivoConsulta} ></textarea>
                                </div>
                            </div>
                            <div className="col-md-3 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Tiempo de enfermedad</label>
                                    <input type="text" name="te" id="te" className="form-control" disabled value={atencion.te} />
                                </div>
                            </div>
                            <div className="col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Antecedentes</label>
                                    <textarea name="antecedentes" id="antecedentes" cols="30" rows="7" className="form-control" disabled value={atencion.antecedentes}></textarea>
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Alergias</label>
                                    <input type="text" name="alergias" id="alergias" className="form-control" disabled value={atencion.alergias} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Intervenciones quirurgicas</label>
                                    <input type="text" name="intervencionesQuirurgicas" id="intervencionesQuirurgicas" className="form-control" disabled value={atencion.intervencionesQuirurgicas} />
                                </div>
                            </div>
                            <div className="col-md-4 col-12">
                                <div className="form-group">
                            ...
                            <div className="col-12">
                                <div className="form-group">
                                    ...
                                    <textarea name="examenFisico" id="examenFisico" cols="30" rows="7" className="form-control" disabled value={atencion.examenFisico}></textarea>
                                </div>
                            </div>
                            <div className="col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Diagnostico</label>
                                    <textarea name="diagnostico" id="diagnostico" cols="30" rows="7" className="form-control" disabled value={atencion.diagnostico}></textarea>
                                </div>
                            </div>
                            <div className="col-12">
                                <div className="form-group">
                                    <label htmlFor="" className="form-label">Tratamiento</label>
                                    <textarea name="tratamiento" id="tratamiento" cols="30" rows="7" className="form-control" disabled value={atencion.tratamiento}></textarea>
                                </div>
                            </div>
                            <div className="col-12">
                                <div className="form-group">
                                            ...
                                            medicamento.map(item => {
                                                return (
                                                    <div className="row">
                                                        <div className="col-6">
                                                            <ul>
                                                                <li><strong>{item.nombre}</strong>: {item.cantidad} {item.presentacion}(s)</li>
                                                            </ul>
                                                        </div>
                                                        <div className="col-6">
                                                            <ul>
                            ...
                            <div className="col-12 text-center">
                                <button type="submit" className="btn btn-primary" onClick={printPDF}><i className="fas fa-print   "></i> Imprimir receta</button>
                            </div>
                        </div>
                    </div>
